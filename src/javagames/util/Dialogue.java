...
public class Dialogue {
  ...
  public Dialogue() {
    ...
    dialogLevel1[4] =
        "Narrator: \"Use the K key to use your magical knives of magic\n and use the J key to jump.\"\n";
    dialogLevel1[5] =
        "Keith: \"Alright, what other moves can I do with my knives?\"\n";
    ...
    dialogLevel1[11] =
        "Keith: \"My name is not Keith, what am I going to do with this?\"\n";
    dialogLevel1[12] =
    ...
    dialogLevel1[15] =
        "Narrator: \"It is not poilte to interrupt, and becuase there was not enough time to put a proper tutorial level together.\"\n";
    dialogLevel1[16] = "Keith: \"Huh, that seems pretty lazy..\"\n";
    dialogLevel1[17] =
        "Narrator: \"Any way as I was saying, \nand pay attention this is crucial to the story.\"\n";
    dialogLevel1[18] =
        "Keith: \"I am not going to read this, just tell me what you want me to do.\"\n";
    dialogLevel1[19] =
        "Narrator: \"Well you need to save Sir Prince Rihanna Beyonce-\"\n";
    dialogLevel1[20] = "Keith: \"Alright save the prince got it.\"\n";
    dialogLevel1[21] =
        "Narrator: \"Wait are you sure you do not want to hear the story?\"\n";
    dialogLevel1[22] = "Keith: \"Nope see ya!\"\n";
    dialogLevel1[23] =
        "Narrator: \"I worked really hard on this story, there was a whole lecture on the history of everything and-\"";

    dialogLevel2[0] =
        "Narrator: \"Alright Keith the castle is straight to the right!\"";
    dialogLevel2[1] =
        "Keith: \"No really? I thought it was in the background.\n";
    dialogLevel2[2] =
        "           I can only move left and right, this world is surprisingly 2 dimensional.\"";
    dialogLevel2[3] =
        "Narrator: \"Fine, you know what, I wont say anything else throughout this level.\"";

    dialogLevel3a[0] =
        "Narrator: \"You are in the castle Keith, the prince is here somewhere.\"";
