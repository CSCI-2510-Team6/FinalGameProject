...
public class EvilKnight extends CollidableSprite {
	...
	private void initAnimations() {
		...
		standRight[0] = Utility.mirrorScaleImage(
				getImage().getSubimage(width, 0, width, height), desiredWidth,
				desiredHeight);
		blockLeft[0] = Utility.scaleImage(
				getImage().getSubimage(0, 0, width, height), desiredWidth,
				desiredHeight);
		blockRight[0] = Utility.mirrorScaleImage(
				getImage().getSubimage(0, 0, width, height), desiredWidth,
				desiredHeight);
		attackLeft[0] = Utility.scaleImage(
